...
%%
(name => 'ref to scalar',
 code => '$a03 = 1; GraphViz::Data::Structure->new(\\$a03,graph=>{label=>"ref to scalar"})->graph->as_canon',
 out  => qq(digraph test {
	graph [label="ref to scalar"];
	node [label="\\N"];
	{
		graph [rank=same];
		gvds_scalar0 [label="", color=white, fontcolor=black, rank=0, shape=record, style=filled];
...
(name => 'ref to ref to scalar',
 code => '$a03 = 1; $b03 = \\$a03; GraphViz::Data::Structure->new(\\$b03,graph=>{label=>"ref to ref to scalar"})->graph->as_canon',
 out  => qq(digraph test {
	graph [label="ref to ref to scalar"];
	node [label="\\N"];
	{
		graph [rank=same];
		gvds_scalar0 [label="", color=white, fontcolor=black, rank=0, shape=record, style=filled];
...
%%
(name => 'ref to self',
 code => '$a03 = \\$a03; GraphViz::Data::Structure->new($a03,graph=>{label=>"ref to self"})->graph->as_canon',
 out  => qq(digraph test {
	graph [label="ref to self"];
	node [label="\\N"];
	{
		graph [rank=same];
		gvds_scalar0 [label="", color=white, fontcolor=black, rank=0, shape=record, style=filled];
...
(name => 'ref to ref to self',
 code => '$a03 = \\$a03; $b03 = \\$a03; GraphViz::Data::Structure->new(\\$b03,graph=>{label=>"ref to ref to self"})->graph->as_canon',
 out  => qq(digraph test {
	graph [label="ref to ref to self"];
	node [label="\\N"];
	{
		graph [rank=same];
		gvds_scalar0 [label="", color=white, fontcolor=black, rank=0, shape=record, style=filled];
...
(name => 'twin circular ref',
 code => '$a03 = \\$b03; $b03 = \\$a03; GraphViz::Data::Structure->new(\\$a03,graph=>{label=>"twin circular ref"})->graph->as_canon',
 out  => qq(digraph test {
	graph [label="twin circular ref"];
	node [label="\\N"];
	{
		graph [rank=same];
		gvds_scalar0 [label="", color=white, fontcolor=black, rank=0, shape=record, style=filled];
...
(name => 'triple circular ref',
 code => '$a03 = \\$b03; $b03 = \\$c03; $c03 = \\$a03; GraphViz::Data::Structure->new(\\$a03,graph=>{label=>"triple circular ref"})->graph->as_canon',
 out  => qq(digraph test {
	graph [label="triple circular ref"];
	node [label="\\N"];
	{
		graph [rank=same];
		gvds_scalar0 [label="", color=white, fontcolor=black, rank=0, shape=record, style=filled];
